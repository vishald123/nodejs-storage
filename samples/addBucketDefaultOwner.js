...
//   title: Storage Default Bucket Owner.
//   description: Adds default bucket owner in Storage.
//   usage: node addBucketDefaultOwner.js <BUCKET_NAME> <USER_EMAIL>
...
function main(bucketName, userEmail) {
  ...
  addBucketDefaultOwner().catch(err => console.log(err));
}
